...
[MDIA] = LAYOUT_split_4x6_5(
    ...
    RM_TOGG,RM_NEXT,RM_HUEU,ALGR(KC_3),_______,_______,                              KC_PGDN,      KC_LEFT,      KC_DOWN,     KC_RIGHT,  _______,_______,
    _______,_______,_______,_______,_______,_______,                              _______,  0xc50, LGUI(KC_NONUS_BACKSLASH),  0xc4f,_______,_______,
    _______,_______,_______,KC_SCLN,_______,_______,     _______,     _______,    _______,_______,_______,_______,_______,_______,
